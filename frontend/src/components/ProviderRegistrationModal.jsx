...
const ProviderRegistrationModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add debugging logs
      console.log('Submitting to:', `${API_BASE_URL}/provider/register`);
      
      // Create a custom Axios instance without auth interceptors
      const response = await axios({
        method: 'post',
        url: `${API_BASE_URL}/provider/register`,
        data: formDataToSend,
        headers: {
                    ...
                    <div className="bg-[#076870]/5 p-3 rounded-lg">
                      ...
                      <div className="mt-2">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full px-2.5 py-1.5 border border-gray-200 rounded-lg focus:ring-1 focus:ring-[#076870] focus:border-[#076870] outline-none transition text-xs appearance-none bg-white bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxNiIgaGVpZ2h0PS"
                          required
                        >
