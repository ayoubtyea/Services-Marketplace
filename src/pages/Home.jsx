        ...
        <motion.div className="relative w-full md:w-64 lg:w-80">
          <div className="relative">
            <motion.img
              ...
              whileHover={{ scale: 1.05 }}
            />
            <div className="bg-[#076870] md:-ml-[40px] p-4 sm:p-6 rounded-lg text-white mt-4 w-full md:w-auto">
              <span className="p-2 flex">
                <a className="text-2xl sm:text-3xl md:text-4xl font-bold">12+ Years</a>
              </span>
          ...
          <div className="md:absolute top-0 left-2/3 transform md:-translate-x-1/5 bg-[#076870] text-white text-center flex-row rounded-[41px] p-4 z-10 mb-2 md:mb-0">
            <span className="p-2">
              <img
                ...
                className="w-6 h-6 sm:w-8 sm:h-8 px-2 rounded-full text-white bg-[#076870] inline-flex justify-center items-center"
                alt="Icon"
              />
            </span>
            <a className="text-xs sm:text-sm">Free Home Services in the next 7 days!</a>
          </div>
